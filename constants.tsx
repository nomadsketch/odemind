...
export const INITIAL_ARCHIVE: ArchiveItem[] = [
  { id: '1', year: '2015 - Present', company: 'Le Labo', category: 'Retail, Beauty', project: 'Ecommerce & Photography' },
  { id: '2', year: '2019 - Present', company: 'Huckberry', category: 'Retail, Apparel', project: 'Headless Ecommerce Launch' },
  { id: '3', year: '2024 - Present', company: 'Filson', category: 'Retail, Apparel', project: 'Ecommerce Relaunch' },
  { id: '4', year: '2024 - Present', company: 'Shinola', category: 'Retail, Accessories', project: 'Ecommerce Relaunch' },
  { id: '5', year: '2025 - Present', company: 'Heath Ceramics', category: 'Retail, Home', project: 'Ecommerce Redesign' },
  { id: '6', year: '2024 - Present', company: 'imogene + willie', category: 'Retail, Apparel', project: 'Ecommerce Relaunch' },
  { id: '7', year: '2023 - 2024', company: 'Rishi Tea', category: 'Retail, Food & Beverage', project: 'Shopify Replatform & Ecommerce Relaunch' },
  { id: '8', year: '2024', company: 'Raaka Chocolate', category: 'Retail, Food & Beverage', project: 'Ecommerce Relaunch' },
  { id: '9', year: '2021 - 2023', company: 'East Fork', category: 'Retail, Home', project: 'Headless Ecommerce Relaunch' },
  { id: '10', year: '2023 - Present', company: 'Jacobsen Salt Co.', category: 'Retail, Food & Beverage', project: 'Ecommerce Relaunch & Art Direction' }
];
